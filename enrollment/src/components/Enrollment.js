...
const Contact = () => {
    ...
    function sendEmailForm(e) {
        ...
        emailjs.sendForm('service_prtkkgq', 'template_votjuxl', 'form', 'QB59AV4sGBP6FfRvo')
            .then((result) => {
                console.log(form);
            }, (error) => {
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <FormGroup>
                                    ...
                                    <Input placeholder="Student's Name" type='text' name='fullName' id='fullName' style={{ marginTop: '15px', marginRight: '7px' }} />
                                </FormGroup>
                                <p>born on</p>
                                <FormGroup>
                                    {/* <Label for="dob">Date of Birth</Label> */}
                                    <Input style={{ marginTop: '15px', marginRight: '7px' }} type="date" name="dob" id="dob" placeholder="date placeholder" />
                                </FormGroup>
                            </div>
                        </div>
                        <div style={{
                            ...
                            <FormGroup>
                                ...
                                <Input style={{ marginTop: '15px', marginLeft: '7px' }} type='text' name='parentsName' id='parentsName' placeholder="Parent's Name" />
                            </FormGroup>
                        </div>
                        ...
                        <div style={{
                            ...
                            <FormGroup>
                                ...
                                <Input style={{
                                    marginTop: '15px',
                                    marginRight: '15px'
                                }} type='text' name='initials2' id='initials2' placeholder="Parent's Full Name" />
                            </FormGroup>
                            <FormGroup required check>
                                <Label check>
                                    <Input style={{
                                        ...
                                        flexWrap: 'nowrap',
                                        marginRight: '25px'
                                    }} type="radio" name="radio3" value={'OK'} />{' '}
                                    OK
                                </Label>
                            </FormGroup>
                            <FormGroup check>
                                <Label check>
                                    <Input style={{
                                        display: 'flex',
                                        flexWrap: 'nowrap',
                                    }} type="radio" name="radio3" value={'Not-OK'} />{' '}
                                    Not OK
                                </Label>
                            </FormGroup>
                            <p>Today's date</p>
